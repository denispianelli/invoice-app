...
export async function Header() {
  ...
  return (
    <header className="fixed top-0 z-50 flex h-[72px] w-full justify-between bg-[#373B53] md:h-[80px] lg:h-screen lg:w-[103px] lg:flex-col lg:items-center lg:rounded-r-2xl">
      <div className="bg-first relative grid w-[72px] place-content-center overflow-hidden rounded-r-2xl lg:h-[103px] lg:w-full">
